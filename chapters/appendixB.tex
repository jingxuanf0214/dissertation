\chapter[Circuit Mechanisms for Spatial Relation Generation in Diffusion Transformers]{Circuit Mechanisms for Spatial Relation Generation in Diffusion Transformers\texorpdfstring{\protect\footnotemark}{}}
\label{Appendix B}
\footnotetext{Published in the IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR).}
